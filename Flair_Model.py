        ...
        for i in tqdm(_train_root.iter('sentence')):
            ...
            for sent, sent1, senses in zip(all_sent, all_sent1, all_senses):
                ...
                try:
                    ...
                    s1 = Sentence(sent1)
                    self.Flair_Model.stacked_embeddings.embed(s1)
                    ...
                    for idx, j in enumerate(zip(senses, sent)):
                        ...
                        if sense != 0:
                            ...
                            embedding = s1[count].embedding.numpy()
...
if __name__=='__main__':
    ...
    parser.add_argument('--trained_pickle',type=str,help='Pickle file of Trained Flair Embeddings/Save Embeddings to this file')
